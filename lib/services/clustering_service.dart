...
class ClusteringService {
  ...
  ClusteringService({
    this.eps = 0.75, // tuned for 512D FaceNet embeddings
    this.minSamples = 1,
    this.mergeThreshold = 0.9, // merge clusters whose centroids are close
    this.assignmentThreshold =
        0.90, // lenient: link new photos of existing people
  });
